...
function secondTurn(piecethis) {
    ...
    if (piece.hasClass('checker')) {
        ...
        var upright = getPieceRelative(piecethis, [1, -1]);
        var upleft = getPieceRelative(piecethis, [-1, -1]);
        var downright = getPieceRelative(piecethis, [1, 1]);
        var downleft = getPieceRelative(piecethis, [-1, 1]);
        var up2right = getPieceRelative(piecethis, [2, -2]);
        var up2left = getPieceRelative(piecethis, [-2, -2]);
        var down2right = getPieceRelative(piecethis, [2, 2]);
        var down2left = getPieceRelative(piecethis, [-2, 2]);
        ...
        $('.selected-o').off('click');
            $('.selected-o:not(.checker-o)').click(function() {
                ...
                $('.selected').removeClass('selected-o');
                // remove all movement classes
                $('.upright').removeClass('upright');
                $('.upleft').removeClass('upleft');
                $('.downright').removeClass('downright');            
...
function prepareForMove() {
    ...
    $('.checker').click(function() {
        if (turn  % 2 == 1) {
            ...
            $('.selected:not(.checker)').off('click');
            $('.selected:not(.checker)').click(function() {
                var piecethis = this;
                var piece = $(this);
                var origin = $('.selected.checker');
    ...
    $('.checker-o').click(function() {
        if (turn  % 2 == 0) {
            ...
            $('.selected-o:not(.checker-o)').off('click');
            $('.selected-o:not(.checker-o)').click(function() {
                var piecethis = this;
                var piece = $(this);
                var origin = $('.selected-o.checker-o');
