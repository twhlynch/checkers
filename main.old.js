...
function checkerClick(obj) {
    if (turn  % 2 == 1) {
        var piece = $(obj);
        //var loc = getPieceLocation(obj);
        var upright = getPieceRelative(obj, [1, -1]);
        var upleft = getPieceRelative(obj, [-1, -1]);
        var downright = getPieceRelative(obj, [1, 1]);
        var downleft = getPieceRelative(obj, [-1, 1]);
        var up2right = getPieceRelative(obj, [2, -2]);
        var up2left = getPieceRelative(obj, [-2, -2]);
        var down2right = getPieceRelative(obj, [2, 2]);
        var down2left = getPieceRelative(obj, [-2, 2]);
        ...
        $('.selected:not(.checker)').click(function() {
            ...
            if (!piece.hasClass('checker')) {
                ...
                if (piece.hasClass('up2right')) {
                    if (getPieceRelative(pieceobj, [-1, 1]).hasClass('checker-o')) {
                        getPieceRelative(pieceobj, [-1, 1]).removeClass('checker-o');
                        second = true;
                    }
                }
                ...
                if (getPieceLocation(pieceobj)[1] == 0) {
                    piece.addClass('king');
                }       
            }
            $('.selected').removeClass('selected');
    ...
    if (turn  % 2 == 0) {
        ...
        $('.selected-o:not(.checker-o)').click(function() {
            ...
            if (!piece.hasClass('checker-o')) {
                ...
                if (piece.hasClass('up2right')) {
                    if (getPieceRelative(pieceobj, [-1, 1]).hasClass('checker')) {
                        getPieceRelative(pieceobj, [-1, 1]).removeClass('checker');
                        second = true;
                    }
                }
                if (piece.hasClass('up2left')) {
                ...
                if (getPieceLocation(pieceobj)[1] == 7) {
                    piece.addClass('king');
                }
            }
            $('.selected-o').removeClass('selected-o');
